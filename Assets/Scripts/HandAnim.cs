...
public class HandAnim : MonoBehaviour
{
  ...
  public const string ANIM_LAYER_NAME_BASE = "Base Layer";
  ...
  private float thumbCap_state = 0f;
    ...
    void Update()
    {
     ...
     if(grip_state>0.8f && trigger_state<0.2f){
        m_animator.SetLayerWeight(m_animLayerIndexPoint, 1f);
      }else if (grip_state<0.8f && trigger_state>0.2f){
        m_animator.SetLayerWeight(m_animLayerIndexPoint, 0f);
